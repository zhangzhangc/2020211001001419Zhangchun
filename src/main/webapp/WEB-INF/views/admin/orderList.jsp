			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.zhangchun.model.Order o=(com.zhangchun.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.zhangchun.dao.UserDao userDao=new com.zhangchun.dao.UserDao();
						...
						<%
							...
							String paymentType=com.zhangchun.model.Payment.findByPaymentId(con,n);
							 %>
